...
- 2026.7.15
  - 发布 `v0.34.0.1-chs-1.0.1a` 版
    - 添加了部分缺失的汉化

- 2026.7.4
  - 发布 `v0.34.0.1-chs-1.0.0a` 版
    - 更新至 `v0.34.0.1`

- 2026.5.25
  - 发布 `v0.33.1.0-chs-2.0.0a` 版
    - 更新至 `v0.33.1.0`

- 2026.5.19
  - 发布 `v0.33.0.1-chs-1.1.0a` 版
    - 添加了部分缺失的汉化

- 2026.5.5
  - 发布 `v0.33.0.1-chs-1.0.0a` 版
    - 更新至 `v0.33.0.1`

- 2025.12.7
  - 发布 `v0.32.0.3-chs-1.2.0a` 版
    - 补充了部分缺失的汉化
    - 补充了部分缺失的字库

- 2025.11.29
  - 发布 `v0.32.0.3-chs-1.1.0a` 版
    - 补充了部分缺失的汉化

- 2025.11.26
  - 发布 `v0.32.0.3-chs-1.0.0a` 版
    - 更新至 `v0.32.0.3`

- 2025.10.12
  - 发布 `v0.31.0.1-chs-1.6.0a` 版
    - 补充了部分缺失的汉化
    - 修正了部分错误的汉化
    - 修正了进入海报天堂时可能报错的问题
    - 修正了读取存档后技术学院所有角色都会进入第一个房间的问题

- 2025.9.19
  - 发布 `v0.31.0.1-chs-1.5.0a` 版
    - 补充了部分缺失的汉化
    - 修正了部分错误的汉化
    - 补充了部分缺失的字库
...
- 2025.9.7
  - 发布 `v0.31.0.1-chs-1.2.0a` 版
    - 补充了部分缺失的汉化
    - 修正了部分错误的汉化

- 2025.9.4
  - 发布 `v0.31.0.1-chs-1.1.0a` 版
    - 补充了部分缺失的汉化
    - 修正了部分错误的汉化
